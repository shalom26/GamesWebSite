...
function createBalloons() {
    ...
    var Balloon1 = {color: 'blue', left: 200, bottom: 20, speed: 0.05};
    var Balloon2 = {color: '#2c704c', left:500, bottom: 20, speed: 0.08};
    var Balloon3 = {color: 'yellow', left: 800, bottom: 20, speed: 0.02};
    var Balloon4 = {color: 'red', left: 1100, bottom: 20, speed: 0.04};
